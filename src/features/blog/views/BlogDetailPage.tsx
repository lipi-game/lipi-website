...
function ShareBox({ title, url }: { title: string; url: string }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5">
      <h3 className="text-sm font-semibold text-gray-900 mb-4">Share this Blog</h3>
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#e8f4fc] rounded-3xl py-12 px-6 md:px-12 text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8 text-sm md:text-base">
            Download Lipi Epics & Word Games, The Interactive Mahabharata Learning App That Combines Storytelling
            And Fun Word Games. Explore Ancient Wisdom Through Engaging Stories, Quizzes, And Language
          ...
          <p className="text-gray-600 text-sm mb-6">
            Join Thousands Of Learners Worldwide In Making The Mahabharata Accessible, Engaging, And Unforgettable. Start Your
            Journey Today — Available Now On iOS And Android.
          </p>
