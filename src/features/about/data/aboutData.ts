export const aboutIntroText = [
  "Lipi Epics and Word Games is a learning and gamification platform that brings Indian epics, languages, and cultural values to life through interactive play. Our mission is to bridge the gap where ancient wisdom is often missing from modern education, helping today's learners explore culture, values, and thinking skills through engaging gameplay.",
  "Modern education rarely covers ancient epics and knowledge systems like the Ramayana, Gita, Vedas, Ayurveda, and Chanakya Neer. At the same time, most language word games available teach only english, missing Indian languages. This feeling engaged with life personally, age-inclusively and gamified content for values, learning, rote memory, logic, rationality, and reliability. We aim to provide digital experiences through apps, games, and a chance to awaken minds for families and communities."
];
